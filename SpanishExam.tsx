...
const EXAM_QUESTIONS: Question[] = [
  ...
  {
    id: 1,
    question: "Yo ___ a la biblioteca para estudiar.",
    translation: "Ես գնում եմ գրադարան սովորելու համար:",
    options: ["vas", "va", "voy"],
    answer: "voy",
  ...
  {
    id: 2,
    question: "¿Adónde ___ tú este fin de semana?",
    translation: "Ո՞ւր ես դու գնում այս հանգստյան օրերին:",
    options: ["va", "vas", "van"],
    answer: "vas",
  ...
  {
    id: 3,
    question: "Nosotros ___ al parque con el perro.",
    translation: "Մենք գնում ենք այգի շան հետ:",
  ...
  {
    id: 4,
    question: "Ellos ___ a comer pizza hoy.",
    translation: "Նրանք պատրաստվում են (գնում են) պիցցա ուտել այսօր:",
    options: ["van", "vamos", "va"],
    answer: "van",
    explanation: "Ellos form of 'ir' is 'van'."
  },
  // GUSTAR section
  {
    id: 5,
    question: "A mí me ___ bailar salsa.",
    translation: "Ինձ դուր է գալիս սալսա պարել:",
    options: ["gusta", "gustan"],
    answer: "gusta",
    explanation: "With infinitives (verbs), we always use 'gusta' (singular)."
  },
  {
    id: 6,
    question: "¿A ti te ___ las manzanas rojas?",
    translation: "Քեզ դուր գալի՞ս են կարմիր խնձորները:",
    options: ["gusta", "gustan"],
    answer: "gustan",
    explanation: "Since 'manzanas' is plural, we use 'gustan'."
  },
  {
    id: 7,
    question: "A nosotros ___ gusta la música española.",
    translation: "Մեզ դուր է գալիս իսպանական երաժշտությունը:",
    options: ["nos", "os", "les"],
    answer: "nos",
    explanation: "The pronoun for 'nosotros' with gustar is 'nos'."
  },
  {
    id: 8,
    question: "A Juan ___ gusta mucho viajar.",
    translation: "Խուանին շատ է դուր գալիս ճանապարհորդել:",
    options: ["le", "me", "te"],
    answer: "le",
    explanation: "The pronoun for 'Juan' (él) is 'le'."
  },
  {
    id: 9,
    question: "Me ___ viajar por todo el mundo.",
    translation: "Ինձ դուր է գալիս ճանապարհորդել ամբողջ աշխարհով:",
    options: ["gusta", "gustan", "gusto"],
    answer: "gusta",
    explanation: "Like #5, plural vs singular depends on what comes after. 'Viajar' is a verb = 'gusta'."
  },
  {
    id: 10,
    question: "¿Te ___ estos zapatos?",
    translation: "Քեզ դուր գալի՞ս են այս կոշիկները:",
    options: ["gusta", "gustan"],
    answer: "gustan",
    explanation: "'Zapatos' is plural, so we use 'gustan'."
  }
];
  ...
  if (gameState === 'intro') {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 text-white font-sans text-center">
        ...
        <p className="text-slate-500 font-bold uppercase tracking-[0.4em] mb-12">Ստուգողական աշխատանք: IR & GUSTAR</p>
